...
import {successGameSettings} from '../../../redux/gameDushboard/dushboardAction'
...
class Form extends Component {
	...
	componentDidMount() {
		const { addDushboard, userGameMode, addGameModeStore } = this.props;
			const userMode = gameMode.find((mode) => mode.name === 'Easy');
			addGameModeStore(gameMode)
...
const mapDispatchToProps = {
	...
	addUserInfo,
	addGameModeStore: successGameSettings
};
